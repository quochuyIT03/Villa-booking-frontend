                    ...
                    <div className="row">
                        <div className="col-lg-12">
                            <span className="breadcrumb">
                                <a href="#" style={{ fontWeight: 'bold', color: 'rgb(243, 85, 37)' }}>Home</a> / Contact Us
                            </span>
                            <h3 style={{ fontSize: '44px' }}>Contact Us</h3>
                        </div>
                    </div>
                </div>
            </div>
                        ...
                        <div className="col-lg-6">
                            ...
                            <div className="contact-info" style={{ marginTop: '100px' }}>
                                ...
                                <div className="item email">
                                    ...
                                    />
                                    <h6>
                                        nguyenquochuy3102@gmail.com<br />
                                        <span>Business Email</span>
                                    </h6>
                                </div>
                            </div>
                        </div>
                        <div className="col-lg-6" style={{ marginBottom: '100px' }}>
